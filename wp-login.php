...
<link rel="stylesheet" id="l10n-css" href="https://ngocnhiap.github.io/doancuoiky/wp-admin/css/l10n.min.css?ver=6.2.2" media="all">
<link rel="stylesheet" id="login-css" href="https://ngocnhiap.github.io/doancuoiky/wp-admin/css/login.min.css?ver=6.2.2" media="all">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://localhost:8080/Doancuoiky/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Đăng nhập">
									<input type="hidden" name="redirect_to" value="http://localhost:8080/Doancuoiky/wp-admin/?simply_static_page=5392">
									<input type="hidden" name="testcookie" value="1">
			</p>
		</form>

					<p id="nav">
				<a href="https://ngocnhiap.github.io/doancuoiky/tai-khoan/lost-password/">Bạn quên mật khẩu?</a>			</p>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="https://ngocnhiap.github.io/doancuoiky/">&larr; Quay lại Doancuoiky</a>		</p>
			</div>
...
<script src="https://ngocnhiap.github.io/doancuoiky/wp-admin/js/password-strength-meter.min.js?ver=6.2.2" id="password-strength-meter-js"></script>
